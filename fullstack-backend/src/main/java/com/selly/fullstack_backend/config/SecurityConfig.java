package com.selly.fullstack_backend.config;


import com.selly.fullstack_backend.filter.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(authorizeRequest ->
                        authorizeRequest
                                .requestMatchers("/login/**", "/register/**", "/refresh_token/**", "/logout/**").permitAll()
                                .anyRequest()
                                .authenticated()
                )
